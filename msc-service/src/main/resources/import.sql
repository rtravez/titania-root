...
INSERT INTO vehiculos (creation_date, creation_host, creation_user, status, imei, placa, chasis, dealer, agencia, marca, modelo, plataforma, customer_id) VALUES (NOW(), '127.0.0.1', 'admin', true, '864209041234567', 'PBA-1234', 'CHS98765432101', 'Dealer Quito', 'Agencia Cumbayá', 'Chevrolet', 'Grand Vitara', 'TrackGps', 1);
INSERT INTO vehiculos (creation_date, creation_host, creation_user, status, imei, placa, chasis, dealer, agencia, marca, modelo, plataforma, customer_id) VALUES (NOW(), '127.0.0.1', 'admin', true, '864209047654321', 'PBB-5678', 'CHS98765432102', 'Dealer Guayaquil', 'Agencia Samborondón', 'Toyota', 'Hilux', 'FleetNav', 1);
