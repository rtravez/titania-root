package com.titania.msc.common;
...
public final class Constants {
	...
	public static final String USERNAME_CLIENT = "titania-web";
	public static final String PASSWORD_CLIENT = "$2a$10$itMT/hPoLNo/FqNuzh69LeNMMUsca/j2WIdOn7P0ZYhjs6rKK/way";
